...
public class WeixinUtil {
	...
	// 菜单查询（GET）
	public static String get_get_url = "https://qyapi.weixin.qq.com/cgi-bin/menu/get?access_token=ACCESS_TOKEN&agentid=AGENTID";
	...
	public static String getMenu(String accessToken, String agentid) {
		String result = null;
		// 拼装创建菜单的url
		String url = get_get_url.replace("ACCESS_TOKEN", accessToken).replace(
				"AGENTID", agentid);
